...
// node_modules/convex/dist/esm/browser/sync/action_manager.js
...
var LocalSyncState = class {
  ...
  queryToken(queryId) {
    var _a;
    return (_a = this.queryIdToToken.get(queryId)) != null ? _a : null;
  }
    ...
    for (const modification of transition.modifications) {
      switch (modification.type) {
        case "QueryUpdated": {
          ...
          const value = jsonToConvex((_a = modification.value) != null ? _a : null);
...
var Base642 = __toESM(require_base64_js(), 1);
  ...
  async connect() {
    ...
    ws.onclose = (event) => {
      ...
      if (this.lastCloseReason === null) {
        this.lastCloseReason = (_a = event.reason) != null ? _a : "OnCloseInvoked";
      }
...
var fetch2 = globalThis.fetch || ((...args) => import("./lib-3ZARBLMO.js").then(
  ({ default: fetch22 }) => fetch22(...args)
));
...
// node_modules/convex/dist/esm/react/use_upload.js
